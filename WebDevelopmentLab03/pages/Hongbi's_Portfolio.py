...
def links_section():
    ...
    #insta_link = f'<a href="{info.my_insta_url}"><img src="{info.insta_image_url}" alt="Insta" width = "65" height = "65"></a>'
    #st.sidebar.markdown(insta_link, unsafe_allow_html=True)

    st.sidebar.text("Or email me!")
    email_html = f'<a href="mailto:{info.my_email_address}"><img src="{info.email_image_url}" alt="Email" width = "65" height = "65"></a>'
